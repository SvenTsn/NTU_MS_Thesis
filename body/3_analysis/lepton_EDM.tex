...
For the electron, an extensive study of eEDM in {\gthdm} can be found in the 2018 and 2020 papers of Fuyuto, Hou, and Senaha (Refs.~\cite{FHS20}).
...
Rearranging~\eqnref{eq:exact-cancellation} thus gives us the form of the cancellation ansatz.
...
On the experiment front, the precision of tau EDM (\(\tau \)EDM) measurements are still pretty low.
...
As seen in \figref{tauEDM}, our predicted values are still several orders of magnitude below current experimental results.
